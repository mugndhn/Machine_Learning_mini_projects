...
def author():                                                                                             
        return "mmurugesan3" # replace gburdell3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903607435 # replace with your GT ID number      
...
class PageRank:
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        ### Implement your code here
        #############################################
                new_pr_values[target] += d*(pr_values[source]/self.node_degree[source])
            for i in range(len(new_pr_values)):
                new_pr_values[i]+=(1-d)*node_weights[i]                
